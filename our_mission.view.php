...
<div class="min-h-full">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="our_mission.php" class="bg-gray-900 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Our Mission</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            Hello Welcome to the Our Mission page
        </div>
    </main>
</div>
